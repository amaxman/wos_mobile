...
public class CustomDatePickerDialogFragment extends DialogFragment implements DatePicker.OnDateChangedListener, View.OnClickListener{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (view != null) {
            datePicker = (DatePicker)view.findViewById(R.id.datePickerView);
            backButton = (TextView)view.findViewById(R.id.back);
            backButton.setOnClickListener(this);
            ensureButton =  (TextView)view.findViewById(R.id.ensure);
    ...
    private void returnSelectedDateUnderLOLLIPOP() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP
            ...
            if (selectedDate.before(startDate) || selectedDate.after(endDate)) {
                Toast.makeText(getActivity(), getString(R.string.exp_date_out_area), Toast.LENGTH_SHORT).show();
                return;
            }
        }
