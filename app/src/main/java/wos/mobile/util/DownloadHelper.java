...
//		}
        ...
        if (this.FileSize <= 0) {
            throw new Exception(Property.context.getString(R.string.download_file_unknown_file_size));
        }

        if (in == null) {
            throw new RuntimeException(Property.context.getString(R.string.download_file_failure));
        }
